  ...
  <script>
    ...
    export default {
      ...
      setup() {
        ...
        const socket = new WebSocket('ws://gamecade-dc594-default-rtdb.asia-southeast1.firebasedatabase.app/')
        ...
        // Stores username and text in an object to be sent to the server
        const sendMessage = () => {
